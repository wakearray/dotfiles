    ...
    services.syncthing = {
      ...
      settings = {
        ...
        devices = {
          ...
          "Kent_HiBreak_Pro_Color"   = { id = "7MZH5DK-OACBPBV-MFASDFO-Z2BXBPT-TD24S2H-WWRNQAS-KAGWZA4-63CRDA3"; };
          # Jess' Computers
          ...
          "Jess_HiBreak_Pro_Color"   = { id = "SSXECJI-K26RNPJ-JJFU7JA-NDCECFY-N5JCRQ5-RSMSFY3-XRZFKN2-T4XQAQT"; };
