...
light="gruvbox-material-dark"
        ...
        "yazi/flavors/gruvbox-material-dark.yazi/flavor.toml" = {
          enable = true;
          force = true;
          text = /* toml */ ''
...
find_position = { fg = "#E78A4E", bg = "reset", italic = true }

# Marker
marker_copied = { fg = "#A9B665", bg = "#A9B665" }
marker_cut = { fg = "#D3869B", bg = "#D3869B" }
marker_marked = { fg = "#7DAEA3", bg = "#7DAEA3" }
marker_selected = { fg = "#DDC7A1", bg = "#DDC7A1" }
...
count_selected = { fg = "#282828", bg = "#DDC7A1" }

# Border
border_symbol = "│"
border_style = { fg = "#7C6F64" }
...
select_main = { fg = "#282828", bg = "#E78A4E", bold = true }
select_alt = { fg = "#A89984", bg = "#504945" }
unset_main = { fg = "#282828", bg = "#A9B665", bold = true }
...
[status] # Find more powerline icons here: https://github.com/just3ws/nerd-font-cheatsheets/blob/master/powerline-extras.md
sep_left = { open = "\ue0be", close = "\ue0b8" }
...
[notify]
title_info = { fg = "#D8A657" }
title_warn = { fg = "#E78A4E" }
...
rules = [
  ...
  { mime = "application/x-{tar,bzip*,7z-compressed,xz,rar}", fg = "#EA6962" },
...
# : }}}
      ...
      "yazi/flavors/gruvbox-material-dark.yazi/tmtheme.xml" = {
        enable = true;
        force = true;
        text = /* xml */ ''
...
<plist version="1.0">
  <dict>
    <key>comment</key>
    <string>Based on gruvbox for Vim (https://github.com/morhetz/gruvbox) but using gruvbox material medium dark colors.</string>
    ...
    <key>name</key>
    <string>gruvbox material (Dark) (Medium)</string>
    ...
    <array>
      ...
      "yazi/flavors/gruvbox-material-dark.yazi/README.md" = {
        enable = false;
        force = true;
        text = ''
